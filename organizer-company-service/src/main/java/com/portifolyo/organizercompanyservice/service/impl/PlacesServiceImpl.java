...
public class PlacesServiceImpl extends BaseServiceImpl<Place> implements PlacesService {
    ...
    @Override
    public List<PlaceInfo> findPlacesByCompanyId(TableRequest request, String id) {
        return this.placeRepository.findPlacesByCompanyId(id, PageRequest.of(request.getPage(), request.getSize()));
    }
}
